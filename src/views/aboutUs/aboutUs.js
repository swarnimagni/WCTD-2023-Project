  ...
  return (
    <div className="App">
      <div className='wrapper'>
        ...
        <AboutUs name="Swarnim" desc="I am an 8th grader located in Michigan. I am interested in Artificial Intelligence and the impacts that it can bring to society. I am all right at coding but want to broaden my current skillset and add additional languages to my repertoire. I currently have an adequate understanding of frontend development, but a limited understanding of backend languages. "></AboutUs>
      </div>
      <Footer></Footer>
    </div>
  );
