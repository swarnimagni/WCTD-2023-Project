...
export default function Footer() {
    return <div className="footer">
        <div className="socials">
            ...
            <a target="_blank" rel="noreferrer" href="https://twitter.com/tech_interrogat"><img className="footer-item" src="https://assets.stickpng.com/images/580b57fcd9996e24bc43c53e.png" alt="Twitter"></img></a>
